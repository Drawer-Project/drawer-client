import { useEditCollectionForm } from "../../use-collection-form";
...
const EditCollectionForm: React.FC<FormProps> = ({ afterSubmit }) => {
  const { form, request } = useEditCollectionForm({ afterSubmit });
